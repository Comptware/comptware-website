...
const SectionSix = () => {
  return (
    <div className="flex flex-col justify-between items-center w-full h-fit my-12 md:my-0 py-14 md:py-28 bg-grey-dull px-5 md:px-[5%] lg:px-[8%]">
      <div className="flex flex-col md:flex-row items-center w-full h-fit gap-y-2 md:gap-x-8 shadow-card-2 rounded-[36px] relative overflow-hidden md:px-16 py-16">
        ...
        <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left w-full h-fit space-y-4 ">
          <p className="text-black-light basier-medium text-[26px] md:text-[32px] pb-4 leading-normal text-left px-5 md:px-0 ">
            Engineered for developers by developers
          </p>
          <p className="text-grey-text font-light text-lg md:text-[24px] text-left pb-5 md:pb-10 px-5 md:px-0 ">
